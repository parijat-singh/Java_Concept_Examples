...
{ 
    ...
    { 
        ...
        // look for the same character before * like geeks*o* so --> 1st star can be s only and 2nd star can be o only
        System.out.println (Pattern.matches("geeks*o?", "geekssos")); 
